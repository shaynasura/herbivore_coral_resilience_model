---
title: "S14_ASS-browsers-sensitivity-analyses"
...
browsers_gT_gM_all <- bind_rows(results_all)
...
write_csv(final_results, "../output/analyses/supplement2/browser_gT_gM_results_all_batches.csv")
...
browsers_gT_gM_all <- read_csv(file = "../../output/analyses/supplement2/supplement2/gT_gM_results_all_batches.csv")
# browsers_gT_gM_all <- read_csv(file = "../../output/analyses/supplement2/supplement2/browser_gT_gM_results_all_batches.csv")
...
final_results <- browsers_gT_gM_all %>%
  mutate(
...
# Create PDF
pdf("../output/figures/fig_S19_browsers_gTgM_v1.pdf", width = 12, height = 10)
...
# Step 5 - Combine Final Results
browsers_alphaT_alphaM_all <- bind_rows(results_all)
...
# write_csv(browsers_alphaT_alphaM_all, "../output/analyses/supplement2/supplement2/alphaT_alphaM_results_all_batches.csv")
write_csv(browsers_alphaT_alphaM_all, "../output/analyses/supplement2/supplement2/browsers_alphaT_alphaM_results_all_batches.csv")
...
browsers_alphaT_alphaM_all <- read_csv(file = "../../output/analyses/supplement2/supplement2/alphaT_alphaM_results_all_batches.csv")
# browsers_alphaT_alphaM_all <- read_csv(file = "../../output/analyses/supplement2/supplement2/browsers_alphaT_alphaM_results_all_batches.csv")
...
final_results <- browsers_alphaT_alphaM_all %>%
  mutate(
...
# Create PDF
pdf("../../output/analyses/supplement2/fig_S20_browsers_aTaM_v2.pdf", width = 12, height = 10)
...
browsers_iT_iC_all <- read_csv(file = "../../output/analyses/supplement2/browsers_iT_iC_results_all_batches.csv")
...
browsers_betaT_betaM_all <- read_csv(file = "../../output/analyses/supplement2/supplement2/browsers_betaT_betaM_results_all_batches.csv")
...
# Create PDF
pdf("../../output/analyses/supplement2/fig_S25_browsers_bTbM_v2.pdf", width = 12, height = 10)
...
browsers_gamma_all <- read_csv(file = "../../output/analyses/supplement2/supplement2/browsers_gamma_results_all_batches.csv")
...
# Create PDF
pdf("../../output/analyses/supplement2/fig_S27_browsers_gamma_v1.pdf", width = 12, height = 10)
